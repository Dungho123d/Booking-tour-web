...
<body ng-app="myApp" ng-controller="MyController">
 ...
 -->
	...
	<div class="container cot">
		...
		<button type="submit" class="btn btn-info trongnuoc" ng-click="show();" >Ngoài nước</button>
		<button type="submit" class="btn btn-info ngoainuoc" ng-click="show();" >Trong nước</button>
