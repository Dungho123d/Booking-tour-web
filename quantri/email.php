...
try {
    ...
    $mail->Username = 'ilovebesun1996@gmail.com';                 // email admin
    $mail->Password = 'iiwovvscaavymnbs';                           //  nhập pass email
    $mail->SMTPSecure = 'tls';                            // Enable TLS encryption, `ssl` also accepted
    $mail->Port = 587;                                    // TCP port to connect to
 
    //Recipients
  	$mail->CharSet = "utf-8";
    $mail->setFrom('hoducdung3103@gmail.com', 'Quản trị trang du lịch cuộc sống');
